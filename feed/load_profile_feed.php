...
if (isset($_POST['username']) && isset($_POST['sessionId']) && isset($_POST['target_username']) && isset($_POST['feed_pos'])) {
    ...
    if($util->isActiveSession($username,$sessionId)) {
      ...
      $feed = $func->loadProfileFeed($username, $target_username, $feed_pos);
